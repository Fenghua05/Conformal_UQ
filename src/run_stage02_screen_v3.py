"""Stage 02 executable with additional pre-outcome OpenML candidate records."""
...
replacements = {
    ...
    '\n]\n\n\ndef utc_now': ',\n    {"id": "openml_23517_numerai28_6", "openml_id": 23517, "name": "numerai28.6", "target": "target", "domain": "financial benchmark", "source_note": "OpenML versioned public benchmark; no era/time field is admitted as a feature in this screen."},\n    {"id": "openml_40701_churn", "openml_id": 40701, "name": "churn", "target": "class", "domain": "customer churn", "source_note": "OpenML versioned public benchmark."},\n    {"id": "openml_41143_jasmine", "openml_id": 41143, "name": "jasmine", "target": "class", "domain": "automl benchmark", "source_note": "OpenML versioned AutoML benchmark."},\n    {"id": "openml_41147_albert", "openml_id": 41147, "name": "albert", "target": "class", "domain": "automl benchmark", "source_note": "OpenML versioned AutoML benchmark."}\n]\n\n\ndef utc_now',
}
